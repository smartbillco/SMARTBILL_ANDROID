...
class ExpensesAll extends StatefulWidget {
  const ExpensesAll({super.key});

  @override
  State<ExpensesAll> createState() => _ExpensesAllState();
}

class _ExpensesAllState extends State<ExpensesAll> {
